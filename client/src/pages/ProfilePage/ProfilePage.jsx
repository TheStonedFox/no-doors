        ...
        <div className={styles['profile-page']}>
            ...
            <section className={styles['profile-page__layout']}>
                <section className={styles['profile-page__actions']}>
                    ...
                    {action !== 'edit' && < BorderedButton className={styles['actions__action-button']} title='История заказов' onClick={() => {
                        setAction('history')

                    }} />}
                    {action === 'edit' && < div className={styles['action__edit-mode-buttons']}>
                        <Button title='Сохранить изменения' />
                        <BorderedButton className={styles['actions__action-button']} title='Отменить редактирование' onClick={() => setAction('')} />
                    </div>}
                </section>
                {action === 'edit' && <section className={styles['profile-page__edit-info']}>
                    ...
                    <div className={styles['edit-info__field']}>
                        ...
                        <Input className={styles['edit-info__input']} type='tel' placeholder='город, улица, дом' />
                    </div>
                </section>}
