    ...
    return (
        <div className={styles['product-card']}>
            ...
            <div className={styles['product-card__bottom-box']}>
                <h2 className={styles['product-card__title']}>iPhone 7 Plus Шлейф кнопки включения + Шлейф громкости Оригинал</h2>
                <div className={styles['product-card__fields']}>
                    <Field tittle='Розница:' value='950 ₽' />
                    <Field tittle='Оптом (от 5 штук):' value='750 ₽' />
                    <Field tittle='В наличии:' value='2536 шт.' />
                </div>
                <div className={styles['product-card__bottom']}>
                    <Counter></Counter>
                    <BorderedButton>В корзину</BorderedButton>
                </div>
            </div>
        </div>
    )
